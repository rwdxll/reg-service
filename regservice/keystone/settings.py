...
_public_data = {"host_name":KEYSTONE_HOST, "port":KEYSTONE_PUBLIC_PORT, "api_version":KEYSTONE_API_VERSION,"api_v2_version" : API_VERSION_V2}
KEYSTONE_PUBLIC_ENDPOINT = "http://{host_name}:{port}/{api_version}".format(**_public_data)
KEYSTONE_PUBLIC_V2_ENDPOINT = "http://{host_name}:{port}/{api_v2_version}".format(**_public_data)
